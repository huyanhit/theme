...
class ZoCoreControl
{
        ...
        <div class="images-field clearfix">
            ...
            foreach ($selected as $value):
                ...
                <li class="items" data-id="<?php echo esc_attr($value); ?>" style="background-image:url(<?php echo esc_url($attachment_image[0]);?>);background-size:cover;">
                    <i class="edit dashicons dashicons-plus-alt" title="<?php _e('Replace Image', 'semitri'); ?>"></i>
                    <i class="remove dashicons dashicons-dismiss" title="<?php _e('Remove Image', 'semitri'); ?>"></i>
                </li>
            <?php endif; endforeach; ?>
            <?php if($params['field'] != 'single'): ?>
                <li class="items" data-id=""><i class="add dashicons dashicons-plus-alt" title="<?php _e('Add Image', 'semitri'); ?>"></i></li>
    ...
    private function social($params){
		...
		<table class="wp-list-table widefat fixed pages zo_social_team">
			<thead>
				<tr>
					<th><?php _e('Title', 'semitri');?></th>
					<th><?php _e('Link', 'semitri');?></th>
					<th><?php _e('Icon class', 'semitri');?></th>
					<th><?php _e('Actions', 'semitri');?></th>
				</tr>
			</thead>
			<tfoot>
				<tr>
				...
				<tr>
					<td colspan="3">
						<a class="button-primary" id="btn_add_social" href="javascript:void(0);"><?php _e('Add new', 'semitri');?></a>
					</td>
				</tr>
			</tfoot>
			<tbody  id="the-list">
				<?php
					if(count($zo_social_team)):
						...
						<tr>
							...
							<td><a title="Click to edit this item" href="javascript:void(0)" class="zo_social"><?php _e('Edit', 'semitri')?></a>|<a class="zo_social_remove" href="javascript:void(0)"><?php _e('Remove', 'semitri')?></a></td>
						</tr>
						<?php endforeach;
					else: ?>
						<tr>
							<td class="zo_no_item" colspan="3"><?php _e('No item!', 'semitri');?></td>
						</tr>
					<?php endif;
				?>
			</tbody>
