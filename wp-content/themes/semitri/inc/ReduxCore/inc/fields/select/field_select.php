    ...
    class ReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'semitri' );
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'semitri' ) . '</strong>';
            }
        } //function
