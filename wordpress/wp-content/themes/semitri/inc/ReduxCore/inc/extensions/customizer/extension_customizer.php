...
echo '1';
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'semitri' ),
                    'reset_confirm'  => esc_html__( 'Are you sure? Resetting will lose all custom values.', 'semitri' ),
                    'preset_confirm' => esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'semitri' ),
