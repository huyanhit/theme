...
if(class_exists('Vc_Manager')){
    ...
    function zo_vc_params() {
        ...
        require( get_template_directory() . '/vc_params/zo_carousel.php' );
    }
}
...
/* Add post favorite */
require( get_template_directory() . '/inc/libs/post_favorite.php' );

/*Custom user*/
require( get_template_directory() . '/inc/libs/custom.user.php' );

/* Add widgets */
require( get_template_directory() . '/inc/widgets/cart_search.php' );
require( get_template_directory() . '/inc/widgets/monster-widget.php' );
...
function zo_setup() {
	 ...
	 */
	load_theme_textdomain( 'semitri', get_template_directory() . '/languages' );
	...
	register_nav_menu( 'primary', __( 'Primary Menu', 'semitri' ) );
...
function zo_scripts_styles() {
	...
	$script_options = array(
	    ...
	    'nicescroll'=> $smof_data['nicescroll']
	);
	...
	if($presets){
		wp_enqueue_style('zotheme-static', get_template_directory_uri() . '/assets/css/presets-'.$presets.'.css', array( 'zotheme-style' ), '1.0.0');
	}else{
		wp_enqueue_style('zotheme-static', get_template_directory_uri() . '/assets/css/static.css', array( 'ori-style' ), '1.0.0');
	}
...
function zo_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Main Sidebar', 'semitri' ),
		'id' => 'sidebar-1',
		'description' => __( 'Appears on posts and pages except the optional Front Page template, which has its own widgets', 'semitri' ),
	...
	register_sidebar( array(
		'name' => __( 'Header Top Left', 'semitri' ),
		'id' => 'sidebar-2',
		'description' => __( 'Appears when using the optional Header with a page set as Header top left', 'semitri' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'Header Top Right', 'semitri' ),
		'id' => 'sidebar-3',
		'description' => __( 'Appears when using the optional Header with a page set as Header top right', 'semitri' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="wg-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Header search', 'semitri' ),
    	'id' => 'sidebar-4',
    	'description' => __( 'Appears when using the optional Menu with a page set as Menu right', 'semitri' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Top 1', 'semitri' ),
    	'id' => 'sidebar-5',
    	'description' => __( 'Appears when using the optional Footer with a page set as Footer Top 1', 'semitri' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Top 2', 'semitri' ),
    	'id' => 'sidebar-6',
    	'description' => __( 'Appears when using the optional Footer with a page set as Footer Top 2', 'semitri' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Top 3', 'semitri' ),
    	'id' => 'sidebar-7',
    	'description' => __( 'Appears when using the optional Footer with a page set as Footer Top 3', 'semitri' ),
	...
	register_sidebar( array(
    	'name' => __( 'Footer Top 4', 'semitri' ),
    	'id' => 'sidebar-8',
    	'description' => __( 'Appears when using the optional Footer with a page set as Footer Top 4', 'semitri' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Bottom Left', 'semitri' ),
    	'id' => 'sidebar-9',
    	'description' => __( 'Appears when using the optional Footer Bottom with a page set as Footer Bottom left', 'semitri' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Bottom Right', 'semitri' ),
    	'id' => 'sidebar-10',
    	'description' => __( 'Appears when using the optional Footer Bottom with a page set as Footer Bottom right', 'semitri' ),
    	'before_widget' => '<aside class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
    ...
    register_sidebar( array(
        'name' => __( 'Shop Sidebar', 'semitri' ),
        'id' => 'sidebar-11',
        'description' => __( 'Appears when using the optional Shop with a page set as Shop Sidebar', 'semitri' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="wg-title"><span>',
        'after_title' => '</span></h3>',
    ...
    register_sidebar( array(
		'name' => __( 'Newsletter', 'semitri' ),
		'id' => 'newsletter',
		'description' => __( 'Appears Newsletter', 'semitri' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="wg-title"><span>',
		'after_title' => '</span></h3>',
    ...
    register_sidebar( array(
		'name' => __( 'Newsletter Title', 'semitri' ),
		'id' => 'newsletter-title',
		'description' => __( 'Appears Newsletter Title', 'semitri' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="wg-title"><span>',
		'after_title' => '</span></h3>',
	...
	register_sidebar( array(
		'name' => __( 'Single Product', 'semitri' ),
		'id' => 'product_single',
		'description' => __( 'Single Product', 'semitri' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="wg-title"><span>',
		'after_title' => '</span></h3>',
	...
	register_sidebar( array(
		'name' => __( 'Search form', 'semitri' ),
		'id' => 'search_form',
		'description' => __( 'Search form', 'semitri' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="wg-title"><span>',
		'after_title' => '</span></h3>',
...
function zo_paging_nav($query = null) {
	...
	$links = paginate_links( array(
			...
			'prev_text' => __( '<i class="fa fa-angle-double-left"></i>', 'semitri' ),
			'next_text' => __( '<i class="fa fa-angle-double-right"></i>', 'semitri' ),
	) );
...
<div class="comment-main">
    <div class="comment-header">
        <?php printf( __( '<span class="comment-author">%s</span>', 'semitri' ), get_comment_author_link() ); ?>
        <span class="comment-date">
            <?php echo get_comment_time('F d. Y')?>
        </span>
        <?php if ( $comment->comment_approved == '0' ) : ?>
            <em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.' , 'semitri'); ?></em>
        <?php endif; ?>
...
function zo_list_post_types() {
     ...
     */
    if( class_exists( 'WooCommerce' ) ) {
        $types['product'] = __('Products', 'semitri');
    }
    /*
...
function zo_categories_postcount_filter ($variable) {
	$variable = str_replace('(', '<span class="count">', $variable);
	$variable = str_replace(')', '</span>', $variable);
	return $variable;
}
add_filter('wp_list_categories','zo_categories_postcount_filter');
